...
# Trimmed for this service. The billing, API-key, session, support, assistant,
# rate-limit and telemetry collections belong to the Node backend now, and it
# applies their indexes at its own startup. Listing them here would import
# modules this service does not ship.
#
# The split is by *ownership*, not convenience: every collection below is
# written only by this service, and none of the ones removed are written by it
# at all. See bot-service/README.md.
