...
import type { BotTemplate, Pricing as PricingData } from "../lib/types";
...
interface LandingProps {
  /**
   * Pricing and templates, fetched on the server.
   *
   * This is the page search engines and first-time visitors see, so its
   * content has to be in the HTML rather than assembled by JavaScript after
   * two round trips. Both are public reads with no session, which is why they
   * can be rendered on the server at all.
   */
  initialPricing?: PricingData | null;
  initialTemplates?: BotTemplate[] | null;
}

export function Landing({ initialPricing = null, initialTemplates = null }: LandingProps) {
    ...
    <Page>
      ...
      <section className="section" id="templates">
        <div className="wrap">
          ...
          <div className="mt-6">
            <TemplatePicker readOnly initialTemplates={initialTemplates} />
          </div>
        </div>
      </section>
