...
import type { Gaps } from "../lib/types";
...
export function GapList() {
  ...
  useEffect(() => {
    api
      ...
      .then((loaded) => {
        setData(loaded);
        // How many gaps someone is looking at, never what was asked — the
        // questions are end users' words, typed at a customer's bot.
        track(EVENTS.GAP_LIST_VIEWED, {
          gap_count: loaded.gaps.length,
          window_days: 30,
        });
      })
