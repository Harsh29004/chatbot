...
Two stores have to agree: ``apps.billing`` knows whether a subscription is
live, and ``shared.api_keys`` knows what an account's daily credit allowance
...
from shared.api_keys import set_daily_credit_limit
