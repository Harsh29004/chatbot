...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    ...
    // This is the only place a render error is available *with* the component
    // stack that produced it — window.onerror sees the exception but not
    // which component threw, and that is usually the whole answer. Marked
    // fatal because reaching here means the user is looking at the fallback
