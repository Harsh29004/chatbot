...
export const RELEASE: string = env.VITE_APP_RELEASE ?? "dev";
...
const analyticsWanted =
  env.VITE_FIREBASE_ANALYTICS_ENABLED !== "false" &&
  Boolean(firebaseConfig.measurementId);

const performanceWanted = env.VITE_FIREBASE_PERFORMANCE_ENABLED !== "false";
